...
class StatusesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'char', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'name' => '',
                'created' => '2020-10-17 07:50:42',
                'modified' => '2020-10-17 07:50:42',
            ],
        ];
        parent::init();
    }
